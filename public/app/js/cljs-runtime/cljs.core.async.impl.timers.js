...
var i_13707 = (self__.level + (1));
while(true){
if((i_13707 <= (new_level + (1)))){
(update[i_13707] = self__.header);
...
while(true){
if((i <= self__.level)){
var links_13711 = (update[i]).forward;
if((i < x__$2.forward.length)){
(x__$2.forward[i] = (links_13711[i]));
} else {
x__$2.forward.push((((i < links_13711.length))?(links_13711[i]):null));
}

if((i < links_13711.length)){
(links_13711[i] = x__$2);
} else {
links_13711.push(x__$2);
}
...
if((x__$1 === (((i_13716 < links_13717.length))?(links_13717[i_13716]):null))){
